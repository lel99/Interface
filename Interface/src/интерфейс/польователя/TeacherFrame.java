...
public class TeacherFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setText("Работа с устройством");
        ...
        jButton3.setText("Добавить ученика");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
         AddUserFrame create = new  AddUserFrame(); //объект другого окна
   ...
   DeviceworkFrame create = new  DeviceworkFrame(); //объект другого окна
         create.show(); // открываем это окно . можно и так ( create.setvisible(true); )
         this.hide(); // закрываем текущее окно . можно и так ( create.setvisible(false); )// TODO add your handling code here:
         // TODO add your handling code here:
